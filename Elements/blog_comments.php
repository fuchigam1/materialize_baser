...
<?php if ($blogContent['BlogContent']['comment_use']): ?>
	<div id="BlogComment" class="section">
		<h4 class="header">この記事へのコメント</h4>
		...
		<table cellpadding="0" cellspacing="0" class="row-table-01">
			...
			<tr>
				...
				<td><?php echo $this->BcForm->input('BlogComment.message', array('type' => 'textarea', 'rows' => 10, 'cols' => 52, 'class' => 'materialize-textarea')) ?></td>
			</tr>
		</table>
		...
		<?php echo $this->BcForm->end(array('label' => '送信する', 'id' => 'BlogCommentAddButton', 'class' => 'btn align-center button')) ?>
